...
const schema: ComponentSchemaV1 = {
  ...
  paletteBookmark: {
    ...
    stateItems: {
      default: ['strokeColor', 'inputColor', 'placeholderColor', 'buttonColor', 'buttonTextColor'],
      hover: ['strokeColor', 'inputColor', 'placeholderColor', 'buttonColor', 'buttonTextColor'],
      focus: ['strokeColor', 'inputTextColor', 'placeholderColor', 'buttonColor', 'buttonTextColor'],
